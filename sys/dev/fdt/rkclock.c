...
#define  RK3128_CRU_PLL_FRACDIV_MASK		SEL(23, 0)
#define  RK3128_CRU_PLL_FRACDIV_SHIFT		0
...
#define  RK3128_CRU_CPU_PLL_SEL_MASK		SEL(14, 13)
#define  RK3128_CRU_CPU_PLL_SEL_SHIFT		13
#define  RK3128_CRU_CPU_PLL_SEL_CPLL		0
#define  RK3128_CRU_CPU_PLL_SEL_GPLL		1
#define  RK3128_CRU_CPU_PLL_SEL_GPLL_DIV2	2
#define  RK3128_CRU_CPU_PLL_SEL_GPLL_DIV3	3
#define  RK3128_CRU_ACLK_CPU_DIV_MASK		DIV(12, 8)
#define  RK3128_CRU_ACLK_CPU_DIV_SHIFT		8
#define  RK3128_CRU_PCLK_CPU_DIV_MASK		DIV(14, 12)
#define  RK3128_CRU_PCLK_CPU_DIV_SHIFT		12
#define  RK3128_CRU_HCLK_CPU_DIV_MASK		DIV(9, 8)
#define  RK3128_CRU_HCLK_CPU_DIV_SHIFT		8
#define  RK3128_CRU_PERI_PLL_SEL_MASK		SEL(15, 14)
#define  RK3128_CRU_PERI_PLL_SEL_SHIFT		14
#define  RK3128_CRU_PERI_PLL_SEL_GPLL		0
#define  RK3128_CRU_PERI_PLL_SEL_CPLL		1
#define  RK3128_CRU_PERI_PLL_SEL_GPLL_DIV2	2
#define  RK3128_CRU_PERI_PLL_SEL_GPLL_DIV3	3
#define  RK3128_CRU_PCLK_PERI_RATIO_MASK	SEL(13, 12)
#define  RK3128_CRU_PCLK_PERI_RATIO_SHIFT	12
#define  RK3128_CRU_HCLK_PERI_RATIO_MASK	SEL(9, 8)
#define  RK3128_CRU_HCLK_PERI_RATIO_SHIFT	8
#define  RK3128_CRU_ACLK_PERI_DIV_MASK		DIV(4, 0)
#define  RK3128_CRU_ACLK_PERI_DIV_SHIFT		0
...
rkclock_get_frequency(struct rkclock_softc *sc, uint32_t idx)
{
	...
	if (clk->parents[mux] == 0)
		return 0;
	idx = clk->parents[mux];
	ret = sc->sc_cd.cd_get_frequency(sc, &idx);
	return ret / (div_con + 1);
}
...
const struct rkclock rk3128_clocks[] = {
	{
		RK3128_ARMCLK, RK3128_CRU_CLKSEL_CON(0),
		(1 << 7), DIV(4, 0),
		{ RK3128_PLL_APLL, RK3128_PLL_GPLL_DIV2 }
	},
	{
		RK3128_SCLK_SDMMC, RK3128_CRU_CLKSEL_CON(11),
		SEL(7, 6), DIV(5, 0),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2,
		  RK3128_XIN24M }
	},
	{
		RK3128_SCLK_SDIO, RK3128_CRU_CLKSEL_CON(12),
		SEL(7, 6), DIV(5, 0),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_XIN24M }
	},
	{
		RK3128_SCLK_EMMC, RK3128_CRU_CLKSEL_CON(12),
		SEL(15, 14), DIV(13, 8),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2,
		  RK3128_XIN24M }
	},
	{
		RK3128_SCLK_UART0, RK3128_CRU_CLKSEL_CON(13),
		SEL(12, 12), DIV(6, 0),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2,
		  RK3128_SCLK_USB480M }
	},
	{
		RK3128_SCLK_MAC, RK3128_CRU_CLKSEL_CON(5),
		SEL(7, 6), DIV(4, 0),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2 }
	},
	{
		RK3128_SCLK_MAC_SRC, RK3128_CRU_CLKSEL_CON(5),
		SEL(7, 6), DIV(4, 0),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2 }
	},
	{
		RK3128_PCLK_I2C0, RK3128_CRU_CLKSEL_CON(10),
		SEL(15, 14), DIV(4, 0),
		{ RK3128_PLL_GPLL, RK3128_PLL_CPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_PLL_GPLL_DIV3 }
	},
	{
		RK3128_PCLK_I2C1, RK3128_CRU_CLKSEL_CON(10),
		SEL(15, 14), DIV(4, 0),
		{ RK3128_PLL_GPLL, RK3128_PLL_CPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_PLL_GPLL_DIV3 }
	},
	{
		RK3128_PCLK_I2C2, RK3128_CRU_CLKSEL_CON(10),
		SEL(15, 14), DIV(4, 0),
		{ RK3128_PLL_GPLL, RK3128_PLL_CPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_PLL_GPLL_DIV3 }
	},
	{
		RK3128_PCLK_I2C3, RK3128_CRU_CLKSEL_CON(10),
		SEL(15, 14), DIV(4, 0),
		{ RK3128_PLL_GPLL, RK3128_PLL_CPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_PLL_GPLL_DIV3 }
	},
	{
		RK3128_PCLK_PWM, RK3128_CRU_CLKSEL_CON(10),
		SEL(15, 14), DIV(4, 0),
		{ RK3128_PLL_GPLL, RK3128_PLL_CPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_PLL_GPLL_DIV3 }
	},
	{
		RK3128_DCLK_VOP, RK3128_CRU_CLKSEL_CON(27),
		SEL(1, 0), DIV(15, 8),
		{ RK3128_PLL_CPLL, RK3128_PLL_GPLL, RK3128_PLL_GPLL_DIV2,
		RK3128_PLL_GPLL_DIV3 }
	},
...
rk3128_init(struct rkclock_softc *sc)
{
	...
	/*
	 * U-Boot leaves the CPU and peripheral buses running well below
	 * what the hardware supports.  Since every register access made
	 * by the CPU crosses both of those clock domains, this makes all
	 * mmio slow, which really hurts drivers that have to fall back
	 * to PIO such as dwmmc(4).  Raise them to the rates Rockchip's
	 * own U-Boot uses.
	 */

	/* aclk_cpu = 148.5 MHz */
	HWRITE4(sc, RK3128_CRU_CLKSEL_CON(0),
	    RK3128_CRU_CPU_PLL_SEL_MASK << 16 |
	    RK3128_CRU_CPU_PLL_SEL_GPLL_DIV2 << RK3128_CRU_CPU_PLL_SEL_SHIFT |
	    RK3128_CRU_ACLK_CPU_DIV_MASK << 16 |
	    1 << RK3128_CRU_ACLK_CPU_DIV_SHIFT);

	/* hclk_cpu = 148.5 MHz, pclk_cpu = 74.25 MHz */
	HWRITE4(sc, RK3128_CRU_CLKSEL_CON(1),
	    RK3128_CRU_HCLK_CPU_DIV_MASK << 16 |
	    0 << RK3128_CRU_HCLK_CPU_DIV_SHIFT |
	    RK3128_CRU_PCLK_CPU_DIV_MASK << 16 |
	    1 << RK3128_CRU_PCLK_CPU_DIV_SHIFT);

	/* aclk_periph = 148.5 MHz, hclk_periph = pclk_periph = 74.25 MHz */
	HWRITE4(sc, RK3128_CRU_CLKSEL_CON(10),
	    RK3128_CRU_PERI_PLL_SEL_MASK << 16 |
	    RK3128_CRU_PERI_PLL_SEL_GPLL_DIV2 << RK3128_CRU_PERI_PLL_SEL_SHIFT |
	    RK3128_CRU_ACLK_PERI_DIV_MASK << 16 |
	    1 << RK3128_CRU_ACLK_PERI_DIV_SHIFT |
	    RK3128_CRU_HCLK_PERI_RATIO_MASK << 16 |
	    1 << RK3128_CRU_HCLK_PERI_RATIO_SHIFT |
	    RK3128_CRU_PCLK_PERI_RATIO_MASK << 16 |
	    1 << RK3128_CRU_PCLK_PERI_RATIO_SHIFT);
...
rk3128_get_pll(struct rkclock_softc *sc, bus_size_t base)
{
	...
	case 1:
		...
		dsmpd = (con & RK3128_CRU_PLL_DSMPD_MASK) >>
		    RK3128_CRU_PLL_DSMPD_SHIFT;
		fracdiv = (con & RK3128_CRU_PLL_FRACDIV_MASK) >>
		    RK3128_CRU_PLL_FRACDIV_SHIFT;
		...
		return ((24000000ULL * fbdiv / refdiv) + frac) / postdiv1 /
		    postdiv2;
	default:
		return 32768;
	}
...
rk3128_get_frequency(void *cookie, uint32_t *cells)
{
	...
	case RK3128_HCLK_SDIO:
	case RK3128_HCLK_EMMC:
		idx = RK3128_HCLK_PERI;
		return rk3128_get_frequency(sc, &idx);
	case RK3128_HCLK_PERI:
		reg = HREAD4(sc, RK3128_CRU_CLKSEL_CON(10));
		switch ((reg & RK3128_CRU_PERI_PLL_SEL_MASK) >>
		    RK3128_CRU_PERI_PLL_SEL_SHIFT) {
		case RK3128_CRU_PERI_PLL_SEL_GPLL:
			idx = RK3128_PLL_GPLL;
			break;
		case RK3128_CRU_PERI_PLL_SEL_CPLL:
			idx = RK3128_PLL_CPLL;
			break;
		case RK3128_CRU_PERI_PLL_SEL_GPLL_DIV2:
			idx = RK3128_PLL_GPLL_DIV2;
			break;
		default:
			idx = RK3128_PLL_GPLL_DIV3;
			break;
		}
		freq = rk3128_get_frequency(sc, &idx);
		/* peri_aclk_div_con */
		freq /= ((reg & RK3128_CRU_ACLK_PERI_DIV_MASK) >>
		    RK3128_CRU_ACLK_PERI_DIV_SHIFT) + 1;
		/* peri_hclk_div_con */
		return freq >> ((reg & RK3128_CRU_HCLK_PERI_RATIO_MASK) >>
		    RK3128_CRU_HCLK_PERI_RATIO_SHIFT);
...
rk3128_set_frequency(void *cookie, uint32_t *cells, uint32_t freq)
{
	...
	switch (idx) {
	case RK3128_PLL_APLL:
		return rk3128_set_pll(sc, RK3128_CRU_APLL_CON(0), freq);
	case RK3128_ARMCLK:
		idx = RK3128_PLL_APLL;
		error = rk3128_set_frequency(sc, &idx, freq);
		if (error == 0) {
			HWRITE4(sc, RK3128_CRU_CLKSEL_CON(0),
			    ((1 << 7) | 0x1f) << 16);
		}
...
rk3128_enable(void *cookie, uint32_t *cells, int on)
{
	...
	switch (idx) {
	case RK3128_SCLK_SDMMC:
	case RK3128_SCLK_EMMC:
	case RK3128_SCLK_UART0:
	case RK3128_SCLK_UART1:
	case RK3128_SCLK_UART2:
	case RK3128_SCLK_MAC:
	case RK3128_SCLK_MAC_RX:
	case RK3128_SCLK_MAC_TX:
	case RK3128_SCLK_SDMMC_DRV:
	case RK3128_SCLK_SDIO_DRV:
	case RK3128_SCLK_EMMC_DRV:
	case RK3128_SCLK_SDMMC_SAMPLE:
	case RK3128_SCLK_SDIO_SAMPLE:
	case RK3128_SCLK_EMMC_SAMPLE:
	case RK3128_SCLK_OTGPHY0:
	case RK3128_SCLK_OTGPHY1:
	...
	case RK3128_HCLK_HOST2:
		/* Enabled by default. */
		return;
	case RK3128_SCLK_SDIO:
		reg = 2; bit = 13;
		break;
	case RK3128_HCLK_SDIO:
		reg = 5; bit = 11;
		break;
	case RK3128_ACLK_VIO0:
		reg = 3; bit = 0;
		break;
	case RK3128_DCLK_VOP:
		reg = 3; bit = 1;
		break;
	case RK3128_ACLK_VIO1:
		reg = 1; bit = 4;
		break;
	case RK3128_ACLK_LCDC0:
		reg = 6; bit = 0;
		break;
	case RK3128_HCLK_LCDC0:
		reg = 6; bit = 1;
		break;
	case RK3128_HCLK_VIO:
		reg = 0; bit = 11;
		break;
	case RK3128_SCLK_MIPI_24M:
		reg = 2; bit = 8;
		break;
	case RK3128_PCLK_MIPIPHY:
		reg = 9; bit = 14;
		break;
	case RK3128_PCLK_MIPI_HOST:
		reg = 9; bit = 5;
		break;
	default:
		printf("%s: %d\n", __func__, idx);
	...
	/* gate register: 1 = gated (disabled), 0 = ungated (enabled) */
	HWRITE4(sc, RK3128_CRU_CLKGATE_CON(reg),
	    (1 << bit) << 16 | (on ? 0 : (1 << bit)));
}
...
rk3128_reset(void *cookie, uint32_t *cells, int on)
{
	...
	HWRITE4(sc, RK3128_CRU_SOFTRST_CON(idx / 16),
	    mask << 16 | (on ? mask : 0));
}
